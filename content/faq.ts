...
export const homepageFAQ: FAQItem[] = [
  ...
  },
  {
    ...
    answer:
      "Yes. We'll help you shape the technical specification around your business goals, so you go into the build knowing exactly what you're getting and why.",
  },
  {
    question: 'How do you keep projects on time and on budget?',
    answer:
  ...
  {
    question: 'Can you take on a complex, ambitious build start to finish?',
    answer:
      "Yes. We're a full-service technology partner — we handle the entire build, from first scope to launch, however complex the idea.",
  },
  {
